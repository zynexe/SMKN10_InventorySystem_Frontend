...
function BHPPage() {
  ...
  const handleDeleteAll = async () => {
    ...
    const confirmResult = window.confirm(
      'WARNING: WARNING: Apakah anda yakin untuk menghapus semua kode barang?'
    );
    
    if (confirmResult) {
      // Double-check with a more specific confirmation
      const secondConfirm = window.confirm(
        `Anda akan menghapus ${filteredData.length} BHP. apakah anda yakin? Semua data akan hilang dan tidak dapat dikembalikan.`
      );
